...
- [Buon Ma Thuot Diocese Management System (GPBMT.ORG) Architecture Document](#table-of-contents)
  ...
  - [Query Keys Pattern](./query-keys-pattern.md)
    - [Keys Factory Example (transactions/keys.ts)](./query-keys-pattern.md#keys-factory-example-transactionskeysts)
    - [Queries Example (transactions/queries.ts)](./query-keys-pattern.md#queries-example-transactionsqueriests)
    - [Mutations Example (transactions/mutations.ts)](./query-keys-pattern.md#mutations-example-transactionsmutationsts)
